...
class MessageFactory
{
    ...
    public function createClientHello(Context $context): ClientHello
    {
        $extensions = $this->config->clientHelloExtensions->createExtensions($context);

        return new ClientHello(
            Version::TLS_1_2, // Legacy version field
            $context->getClientRandom() ?? RandomGenerator::generateClientRandom(),
